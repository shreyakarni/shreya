...
<body bgcolor="skyblue">
  ...
  <br /><br />
  <h3><marquee>Developed by:Surekha Y</marquee></h3>
<div class="topnav">
...
<form method="POST" style="border:1px solid #ccc">
  <div class="container">
   ...
   <label for="flat_no"><b>Flat number</b></label>
    ...
    <input type="text" placeholder="Enter Owner Name" name="f2" required><br/><br/>
	
	<label for="phone_no"><b>Phone number</b></label>
    <input type="number" maxlength="10" placeholder="Enter Phone number" name="f3" required><br/><br/>
	
	
	
	<label for="email"><b>Email</b></label>
    <input type="email" placeholder="Enter Email" name="f4" required><br/><br/>
	
	<label for="postal_address"><b>Postal_adress</b></label>
    <input type="text" placeholder="Enter postal adress" name="f5" required><br/>
	...
	$query=mysqli_query($conn,"INSERT INTO flat_details VALUES('$v1','$v2','$v3','$v4','$v5','$v6')");
	if(($query))
	{
